...
const getBranchStatsIR: any = {
  usedParamSet: { branchId: true },
  params: [
    {
      name: 'branchId',
      required: true,
 ...
 * ```
 */
export const getBranchStats = new PreparedQuery<
  GetBranchStatsParams,
  GetBranchStatsResult
>(getBranchStatsIR)
...
const getUsersByBranchIR: any = {
  usedParamSet: { branchId: true, role: true, limit: true, offset: true },
  params: [
    {
      name: 'branchId',
      required: true,
 ...
 * ```
 */
export const getUsersByBranch = new PreparedQuery<
  GetUsersByBranchParams,
  GetUsersByBranchResult
>(getUsersByBranchIR)
 ...
 * ```
 */
export const createPayment = new PreparedQuery<
  CreatePaymentParams,
  CreatePaymentResult
>(createPaymentIR)
 ...
 * ```
 */
export const getPaymentsByUser = new PreparedQuery<
  GetPaymentsByUserParams,
  GetPaymentsByUserResult
>(getPaymentsByUserIR)
 ...
 * ```
 */
export const logAdminAction = new PreparedQuery<
  LogAdminActionParams,
  LogAdminActionResult
>(logAdminActionIR)
...
const getAdminActionLogsIR: any = {
  usedParamSet: { branchId: true, limit: true, offset: true },
  params: [
    {
      name: 'branchId',
      required: true,
 ...
 * ```
 */
export const getAdminActionLogs = new PreparedQuery<
  GetAdminActionLogsParams,
  GetAdminActionLogsResult
>(getAdminActionLogsIR)
 ...
 * ```
 */
export const getBranchSettings = new PreparedQuery<
...
const updateBranchSettingsIR: any = {
  usedParamSet: {
 ...
 * ```
 */
export const updateBranchSettings = new PreparedQuery<
  UpdateBranchSettingsParams,
  UpdateBranchSettingsResult
>(updateBranchSettingsIR)
...
const createBranchSettingsIR: any = {
  usedParamSet: {
    branchId: true,
    cancellationHoursBefore: true,
    timezone: true,
 ...
 * ```
 */
export const createBranchSettings = new PreparedQuery<
  CreateBranchSettingsParams,
  CreateBranchSettingsResult
>(createBranchSettingsIR)
...
const getNotificationSettingsIR: any = {
  usedParamSet: { branchId: true },
  params: [
    {
      name: 'branchId',
 ...
 * ```
 */
export const getNotificationSettings = new PreparedQuery<
  GetNotificationSettingsParams,
  GetNotificationSettingsResult
>(getNotificationSettingsIR)
...
const updateNotificationSettingIR: any = {
  usedParamSet: {
    isEnabled: true,
    emailTemplate: true,
    branchId: true,
 ...
 * ```
 */
export const updateNotificationSetting = new PreparedQuery<
  UpdateNotificationSettingParams,
  UpdateNotificationSettingResult
>(updateNotificationSettingIR)
...
const createNotificationSettingIR: any = {
  usedParamSet: {
    branchId: true,
    notificationType: true,
    isEnabled: true,
 ...
 * ```
 */
export const createNotificationSetting = new PreparedQuery<
  CreateNotificationSettingParams,
  CreateNotificationSettingResult
>(createNotificationSettingIR)
...
const createBranchIR: any = {
  usedParamSet: { name: true, address: true, phone: true, email: true },
  params: [
    {
      name: 'name',
      required: true,
 ...
 * ```
 */
export const createBranch = new PreparedQuery<
  CreateBranchParams,
  CreateBranchResult
>(createBranchIR)
 ...
 * ```
 */
export const getAllBranches = new PreparedQuery<
 ...
 * ```
 */
export const deleteUser = new PreparedQuery<DeleteUserParams, DeleteUserResult>(
  deleteUserIR
)
 ...
 * ```
 */
export const getAllUsers = new PreparedQuery<
  GetAllUsersParams,
  GetAllUsersResult
>(getAllUsersIR)
 ...
 * ```
 */
export const getUsersPaginated = new PreparedQuery<
...
const getUsersCountIR: any = {
  usedParamSet: { branchId: true, role: true },
  params: [
    {
      name: 'branchId',
      required: true,
 ...
 * ```
 */
export const getUsersCount = new PreparedQuery<
  GetUsersCountParams,
  GetUsersCountResult
>(getUsersCountIR)
...
const getAllPackageTemplatesIR: any = {
  usedParamSet: { branchId: true },
  params: [
    {
      name: 'branchId',
 ...
 * ```
 */
export const getAllPackageTemplates = new PreparedQuery<
  GetAllPackageTemplatesParams,
  GetAllPackageTemplatesResult
>(getAllPackageTemplatesIR)
...
const getPackageInvitationsIR: any = {
  usedParamSet: { branchId: true },
  params: [
    {
      name: 'branchId',
 ...
 * ```
 */
export const getPackageInvitations = new PreparedQuery<
  GetPackageInvitationsParams,
  GetPackageInvitationsResult
>(getPackageInvitationsIR)
 ...
 * ```
 */
export const getClientPackages = new PreparedQuery<
  GetClientPackagesParams,
  GetClientPackagesResult
>(getClientPackagesIR)
 ...
 * ```
 */
export const getClientBookings = new PreparedQuery<
  GetClientBookingsParams,
  GetClientBookingsResult
>(getClientBookingsIR)
 ...
 * ```
 */
export const getAllPayments = new PreparedQuery<
...
const getCurrentBranchContextIR: any = {
  usedParamSet: { userId: true },
  params: [
    {
      name: 'userId',
 ...
 * ```
 */
export const getCurrentBranchContext = new PreparedQuery<
  GetCurrentBranchContextParams,
  GetCurrentBranchContextResult
>(getCurrentBranchContextIR)
...
const getUserDetailsIR: any = {
  usedParamSet: { userId: true, branchId: true },
  params: [
    {
      name: 'userId',
      required: true,
 ...
 * ```
 */
export const getUserDetails = new PreparedQuery<
...
const getAdminClassesByMonthIR: any = {
  usedParamSet: { branchId: true, year: true, month: true },
  params: [
    {
      name: 'branchId',
      required: true,
 ...
 * ```
 */
export const getAdminClassesByMonth = new PreparedQuery<
  GetAdminClassesByMonthParams,
  GetAdminClassesByMonthResult
>(getAdminClassesByMonthIR)
